...
public class SessionProducerWebMeta extends SessionProducerWeb {

    private final static String TUM3_CFG_ws_raw_meta_out_buff_kbytes = "ws_raw_meta_out_buff_kbytes";
    private static final int CONST_WS_META_BUFF_SIZE_def = 32; // 32 Kbytes (smaller default)
    ...
    private static final int[] InitWsBuffSizeConst() {
        ...
        for (int tmp_i = 0; tmp_i < tmp_arr.length; tmp_i++) {
            tmp_arr[tmp_i] = 1024 * Tum3cfg.getIntValue(tmp_i, true, TUM3_CFG_ws_raw_meta_out_buff_kbytes, CONST_WS_META_BUFF_SIZE_def);
            Tum3Logger.DoLog(cfg.getDbName(tmp_i), false, "DEBUG: CONST_WS_META_BUFF_SIZE=" + tmp_arr[tmp_i]);
        }
        return tmp_arr;

    }

    public SessionProducerWebMeta(int _db_idx) {
