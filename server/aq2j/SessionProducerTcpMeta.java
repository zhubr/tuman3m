...
public class SessionProducerTcpMeta extends SessionProducerTcp {

    protected final static String TUM3_CFG_max_meta_inp_buff_kbytes = "max_meta_inp_buff_kbytes";
    protected final static int META_MAX_INP_BUFF_KBYTES_default = 128;
    protected final static String TUM3_CFG_tcp_meta_out_buff_kbytes = "tcp_meta_out_buff_kbytes";
    ...
    private static final int[] InitMaxInpBuffConst() {
        ...
        for (int tmp_i = 0; tmp_i < tmp_arr.length; tmp_i++) {
            tmp_arr[tmp_i] = 1024 * Tum3cfg.getIntValue(tmp_i, true, TUM3_CFG_max_meta_inp_buff_kbytes, META_MAX_INP_BUFF_KBYTES_default);
    ...
    public SessionProducerTcpMeta(int _db_idx, String _listen_addr) throws Exception {
    ...
    public SrvLinkBase newSrvLink(SrvLinkOwner thisOwner) {
        ...
        return new SrvLinkMetaSrv(db_index, thisOwner);
    ...
    public void CONST_TCP_BUFF_SIZE(int _default) {
        CONST_TCP_BUFF_SIZE_bytes = 1024 * Tum3cfg.getIntValue(db_index, false, TUM3_CFG_tcp_meta_out_buff_kbytes, CONST_TCP_BUFF_SIZE_default);
    }
