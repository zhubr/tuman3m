...
public class SessionProducerWebBulkSrv extends SessionProducerWeb {

    private final static String TUM3_CFG_ws_raw_bulk_out_buff_kbytes = "ws_raw_bulk_s_out_buff_kbytes";
    private static final int CONST_WS_BULK_BUFF_SIZE_def = 200; // Kbytes
    ...
    public SessionProducerWebBulkSrv(int _db_idx) {
