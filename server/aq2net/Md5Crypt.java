...
// This file is a combined derivative of several org.apache.commons.codec.digest units.
...
public class Md5Crypt {
    ...
    public static String apr1Crypt(final String keyBytes) {
        return apr1Crypt(keyBytes.getBytes(UTF_8));
    }
    ...
    public static String apr1Crypt(final String keyBytes, final String salt) {
        return apr1Crypt(keyBytes.getBytes(UTF_8), salt);
    }
    ...
    public static String md5Crypt(final byte[] keyBytes, final String salt, final String prefix) {
        ...
        final byte[] saltBytes = saltString.getBytes(UTF_8);
         ...
         */
        ctx.update(prefix.getBytes(UTF_8));
